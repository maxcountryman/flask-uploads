...
latex_documents = [
    (
        "index",
        "Flask-Uploads.tex",
        u"Flask-Uploads Documentation",
        u'Matthew "LeafStorm" Frazier',
        "manual",
    ),
]
...
man_pages = [
    ("index", "flask-uploads", u"Flask-Uploads Documentation", [u'Matthew "LeafStorm" Frazier'], 1)
]


# Example configuration for intersphinx: refer to the Python standard library.
intersphinx_mapping = {"http://docs.python.org/": None, "http://flask.pocoo.org/docs/": None}
